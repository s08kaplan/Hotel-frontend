...
const Booking = () => {
  ...
  // };
  return (
    <Box sx={{marginTop:"1rem", padding:".3rem", display:"flex", flexDirection:"column",  justifyContent:"center", alignItems:"center"}}>
    ...
    //     <Stack sx={{flexDirection:"column", gap:"1rem", margin:".5rem auto"}}>
